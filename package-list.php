...
{	?>
			<div class="rom-btm">
				...
				<div class="col-md-3 room-right wow fadeInRight animated" data-wow-delay=".5s">
					...
					<a href="manali/manali-hotels1.php?pkgid=<?php echo htmlentities($result->PackageId);?>" class="view">Details</a>
				</div><?php }
				...
				<div class="col-md-3 room-right wow fadeInRight animated" data-wow-delay=".5s">
					<h5>Rs.<?php echo htmlentities($result->PackagePrice);?></h5>
					<a href="kerala/kerala-hotels.php?pkgid=<?php echo htmlentities($result->PackageId);?>" class="view">Details</a>
				</div><?php }
				...
				<div class="col-md-3 room-right wow fadeInRight animated" data-wow-delay=".5s">
					<h5>Rs.<?php echo htmlentities($result->PackagePrice);?></h5>
					<a href="ladakh/ladakh-hotels.php?pkgid=<?php echo htmlentities($result->PackageId);?>" class="view">Details</a>
				</div><?php }
				else if(($result->PackageName)=="Goa"){?>
				<div class="col-md-3 room-right wow fadeInRight animated" data-wow-delay=".5s">
					<h5>Rs.<?php echo htmlentities($result->PackagePrice);?></h5>
					<a href="Goa/goa-hotels.php?pkgid=<?php echo htmlentities($result->PackageId);?>" class="view">Details</a>
				</div><?php }
				?>
